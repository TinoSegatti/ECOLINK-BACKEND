...
exports.testSMTPHandler = void 0;
...
const testSMTPHandler = async (req, res) => {
    ...
    try {
        ...
        try {
            ...
            const timeoutPromise = new Promise((_, reject) => setTimeout(() => reject(new Error("Timeout después de 30 segundos")), 30000));
...
exports.testSMTPHandler = testSMTPHandler;
